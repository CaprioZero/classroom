...
if (isset($_POST["submit"]))
{
   $Post = $_POST["postArea"];
    ...
    else
    {
        ...
        {
            $Query = "UPDATE posts SET datetime='$DateTime', content='$Post', file='$File' WHERE post_id='$PostIdFromGet'";
        }
        else {
            $Query = "UPDATE posts SET datetime='$DateTime', content='$Post' WHERE post_id='$PostIdFromGet'";
        }
...
echo SuccessMessage();
global $connection;
$viewQuery = "SELECT * FROM posts WHERE post_id='$PostIdFromGet'";
$Execute = mysqli_query($connection, $viewQuery);
while ($DataRows = mysqli_fetch_array($Execute))
{
    $OldContent = $DataRows["content"];
}
?>
                  ...
                  <div class="form-group">
                        ...
                        <textarea class="form-control" name="postArea" id="postArea" rows="9"><?php echo $OldContent; ?></textarea>
                     </div>
                     ...
                     <button type="submit" name="submit" class="btn btn-success">Edit post</button>
                  </form>
               </div>
            </main>
         </div>
